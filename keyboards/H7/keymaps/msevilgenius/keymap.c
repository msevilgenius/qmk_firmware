...
enum layer_number {
  _BASE = 0,   // Base layer
  _CLMK,       // colemak layout (plus some other adjustments for easier typing)
  _APL,        // APL symbols
  _SYML,       // lower case greek symbols
  _SYMU,       // upper case greek symbols
  _FN,         // FN & media keys
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_BASE] = H7_KEYMAP(
    ...
    KC_F9,  KC_F10,  H_TTY,     TG(_CLMK), KC_HOME,  KC_END ,  MO(_SYML), KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,     KC_N,    KC_M,     KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT, MO(_SYML),KC_UP,    KC_END,                        KC_P1,    KC_P2,     KC_P3,    KC_EQL,
  ...
  */
  [_CLMK] = H7_KEYMAP(
    ...
    FT,      FT,      FT,       FT,       FT,       FT,       FT,       KC_Q,     KC_W,     KC_F,     KC_P,     KC_G,    KC_J,     KC_L,    KC_U,     KC_Y,  H_SEMI_COLON__BACKTICK,     FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
    FT,      FT,      FT,       FT,       FT,       FT,       FT,       KC_A,     KC_R,     KC_S,     KC_T,     KC_D,    KC_H,     KC_N,    KC_E,     KC_I,     KC_O,    H_TICK__DOUBLE_QUOTE,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT,
    FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       KC_Z,     KC_X,     KC_C,     KC_V,    KC_B,     KC_K,    KC_M,      FT,      FT,       FT,       FT,      FT,      FT,       FT,                            FT,      FT,       FT,      FT,
    FT,      FT,      FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       FT,       KC_BSPC, FT,       KC_SPC,  FT,       FT,      FT,       FT,       FT,      FT,      FT,                                      FT,      FT,       FT,      FT
  ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  // don't trigger the solenoid on keys assigned to KC_NO to prevent POS keys from triggerimg it twice
